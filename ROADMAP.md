...
- [ ] v0.6.0: notification and OSD depth plus a foundation-first design overhaul. Establish shared visual primitives, then redesign every shell surface around layered organic depth, stronger hierarchy, refined Adwaita typography, sparse semantic accents, and restrained tactile motion. Improve grouping, navigation, transitions, and feedback without expanding the feature set. Review representative flows across the bar, popovers, control center, settings, notifications, OSD, reminders, and power surfaces, including multi-output, reduced-motion, empty, unavailable, error, and content-overflow states. Popup cards and history show images and avatars. Display durations follow urgency. History persists to disk across reloads and restarts. A generic CLI-driven OSD accepts any icon, message, and progress. Timed reminders have a review overlay
